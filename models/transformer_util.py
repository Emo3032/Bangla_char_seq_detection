...
class PositionalEncodingImage(nn.Module):
    ...
    def __init__(self, d_model, max_h = 2000, max_w = 2000, persistent = False):
        super().__init__()
    ...
    @staticmethod
    def make_pe(d_model, max_h, max_w):
...
class PositionalEncoding(torch.nn.Module):
    def __init__(self, d_model: int, dropout = 0.1, max_len = 5000, persistent = False):
        super().__init__()
